...
Route::group(array('domain' => $_ENV['DOMAIN_MOBILE']), function () {
    ...
    Route::get('/get_password',function(){
        ...
        $queries = Input::all();
        return View::make('mobile_layout')->nest('content', 'mobile.get_password',array('queries'=>$queries));
    });

    Route::post('/get_password',function(){
        $telephone = Input::get('telephone');
    ...
    Route::get('/mobile_set',array('before'=>'weixin',function(){
        MobileLayout::$activeService = 'center';
    ...
    Route::get('/mobile_change_telephone',array('before'=>'weixin',function(){
        $queries = Input::all();
        MobileLayout::$activeService = 'center';
        ...
        $user = Auth::getUser();
        $telephone = $user->telephone;
        return View::make('mobile_layout')->nest('content', 'mobile.change_telephone',array('telephone'=> $telephone,'queries'=>$queries));
    }));

    Route::post('/mobile_change_telephone',array('before'=>'weixin',function(){
        $telephone = Input::get('newtelephone');
        $validcode = Input::get('validcode');
        $user = Auth::getUser();
