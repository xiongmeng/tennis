...
//            $buff .= strtolower($k) . "=" . $v . "&";
	...
	{
        error_log("\r\n" . "original obj:\t" . print_r($Obj, true) . "\r\n", 3, '/var/www/tennis/app/storage/logs/laravel.log');
...
//			$Parameters[strtolower($k)] = $v;
        ...
        error_log("obj which convert key to lower:\t" . print_r($Parameters, true) ."\r\n", 3, '/var/www/tennis/app/storage/logs/laravel.log');

		//签名步骤一：按字典序排序参数
		ksort($Parameters);

        error_log("sorted obj:\t" . print_r($Parameters, true) ."\r\n", 3, '/var/www/tennis/app/storage/logs/laravel.log');
		$String = $this->formatBizQueryParaMap($Parameters, false);
        error_log("formatted string:\t" . $String ."\r\n", 3, '/var/www/tennis/app/storage/logs/laravel.log');
		//echo "【string】 =".$String."</br>";
		//签名步骤二：在string后加入KEY
		$String = $String."&key=".WxPayConf::KEY;
        error_log("string which contact the key:\t" . $String ."\r\n", 3, '/var/www/tennis/app/storage/logs/laravel.log');
		//echo "【string】 =".$String."</br>";
		//签名步骤三：MD5加密
		$result_ = strtoupper(md5($String));
        error_log("string md5 and upper:\t" . $result_ ."\r\n", 3, '/var/www/tennis/app/storage/logs/laravel.log');
        return $result_;
	}
...
class Wxpay_client_ extends Common_util_ 
{
	...
	{
	    $xml = $this->createXml();
        error_log($xml, 3, '/var/www/tennis/app/storage/logs/laravel.log');
...
{	
	...
	{
		$this->getResult();
        error_log(print_r($this->result, true), 3, '/var/www/tennis/app/storage/logs/laravel.log');
...
//        $jsApiObj["timeStamp"] = "1411052570";
	    $jsApiObj["nonceStr"] = 'ryh9fa4e441akugcpsvvesunihg9b2yw';
