...
<div class="bar bar-standard bar-footer-secondary toolbar">
    <div class="segmented-control" data-bind="visible:inSearching()" style="display: none">
        <p class="control-item" >正在加载， 请稍候...</p>
    </div>

    <div class="segmented-control" data-bind="visible:!inSearching() && last_page()>current_page()" style="display: none">
        <a class="control-item" data-bind="click:$root.pre">上一页</a>
        <span class="control-item"><span data-bind="text:current_page"></span>/<span data-bind="text:last_page"></span>页</span>
        <a class="control-item" data-bind="click:$root.next">下一页</a>
    </div>
</div>

<script type="text/javascript">
    seajs.use(['hall/list', 'knockout_switch_case'], function (HallList, switchCase) {
        var hallList = new HallList({model: 'page', relations: 'HallPrices'});
