...
<nav class="bar bar-tab">
    <a class="tab-item" href="<?= url_wrapper('/mobile_home/instant') ?>" data-transition="slide-in" data-ignore="push">
        ...
        <span class="tab-label">即时订单</span>
    </a>
    <a class="tab-item" href="<?= url_wrapper('/mobile_home/reserve/recommend') ?>" data-transition="slide-in" data-ignore="push">
        <span class="icon icon-star-filled"></span>
        <span class="tab-label">预约订单</span>
    </a>
